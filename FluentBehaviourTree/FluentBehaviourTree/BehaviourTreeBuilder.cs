...
namespace FluentBehaviourTree
{
	...
	public class BehaviourTreeBuilder
	{
		...
		/// </summary>
		private readonly Stack<IParentBehaviourTreeNode> parentNodeStack = new Stack<IParentBehaviourTreeNode>();
		...
		public BehaviourTreeBuilder Splice(IBehaviourTreeNode subTree)
		{
			...
			if (parentNodeStack.Count <= 0)
			{
				throw new Exception("Can't splice an unnested sub-tree, there must be a parent-tree.");
			}
